...
export default function TabDropdown({ label, option1, href1, option2, href2}) {
    return (
        <Dropdown className="flex w-full">
            ...
            <DropdownMenu>
                <DropdownItem className="hover:bg-[var(--primary-orange-100)] active:bg-[var(--primary-orange-100)]" key={option1} href={href1}>
                    {option1}
                </DropdownItem>

                <DropdownItem className="hover:bg-[var(--primary-orange-100)]" key={option2} href={href2}>
                    {option2}
                </DropdownItem>
            </DropdownMenu>
        </Dropdown>
