...
const Login = () => {
  return (
    <div className='w-[100vw] h-[100vh] bg-[#CECECE] flex items-center justify-center relative'>
      <div className='absolute h-fit top-0 left-1/2 -translate-x-1/2 w-fit gap-4 flex items-center py-2'>
        ...
        <p className='flex-1 text-center text-black font-bold text-2xl'>CÔNG TY Tnhh tvp comestics</p>
      </div>
